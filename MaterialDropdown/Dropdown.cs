    ...
    public class Dropdown : UIView
    {
        ...
        public DismissMode DismissMode
        {
            ...
            set
            {
                ...
                {
                    gestureRecognizer = new UITapGestureRecognizer(() => DismissableViewTapped());
        ...
        private ComputeLayoutTuple ComputeLayoutBottomDisplay(UIWindow window)
        {
            ...
            var keyboardMinY = keyboardListener.KeyboardFrame.GetMinY();
        ...
        private ComputeLayoutTuple ComputeLayoutForTopDisplay(UIWindow window)
        {
            ...
            var windowY = window.Bounds.GetMinY();
        ...
        public void StartListingToNotifications()
        {
        ...
        {
            readonly WeakReference<Dropdown> dropdownReference;
            ...
            public DropdownDatasource(Dropdown dropdown)
            {
                ...
                this.dropdownReference = new WeakReference<Dropdown>(dropdown);
            }
